...
### Fixed
- Scope auto-tag app token

## [1.3.5] - 2026-05-30


### Fixed
- Gate FuzzSameHost differential on well-formed hosts

## [1.3.4] - 2026-05-29


### Fixed
- Use compile_native_go_fuzzer_v2 so CFL coverage reports non-zero (#256)

## [1.3.3] - 2026-05-17


### Fixed
- Advertise PATCH in Allow header for OPTIONS Max-Forwards:0 responses (#235)

## [1.3.2] - 2026-05-17


### Security
- Close on upstream drain failure; fix shutdown race (#232)

## [1.3.1] - 2026-05-16


### Fixed
- Match IPv6 no-proxy rules for bracketed portless hosts

## [1.3.0] - 2026-05-15


### Added
- Enforce RFC framing conformance on upstream responses
...
[1.3.6]: https://github.com/andrewesweet/spnego-proxy/compare/v1.3.5...v1.3.6
[1.3.5]: https://github.com/andrewesweet/spnego-proxy/compare/v1.3.4...v1.3.5
[1.3.4]: https://github.com/andrewesweet/spnego-proxy/compare/v1.3.3...v1.3.4
[1.3.3]: https://github.com/andrewesweet/spnego-proxy/compare/v1.3.2...v1.3.3
[1.3.2]: https://github.com/andrewesweet/spnego-proxy/compare/v1.3.1...v1.3.2
[1.3.1]: https://github.com/andrewesweet/spnego-proxy/compare/v1.3.0...v1.3.1
[1.3.0]: https://github.com/andrewesweet/spnego-proxy/compare/v1.2.6...v1.3.0
